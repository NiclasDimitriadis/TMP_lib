...
// testing applicative_pure_t
template<int a, int b, int c>
struct sum_of_vals{
    static constexpr int value = a+b+c;
};

using Applicative_NTP1 = param_pack::non_type_pack<int,1,2,10>;
using Applicative_NTP2 = param_pack::non_type_pack<int,1,5,100>;
using Applicative_NTP3 = param_pack::non_type_pack<int,2,7,300>;

using Applicative_NTP4 = Applicative_NTP1::applicative_pure_t<sum_of_vals,Applicative_NTP2,Applicative_NTP3>;

static_assert(Applicative_NTP4::index_v<0> == 4);
static_assert(Applicative_NTP4::index_v<1> == 14);
static_assert(Applicative_NTP4::index_v<2> == 410);
...
static_assert(std::is_same_v<param_pack::non_type_pack<const double,111.22>,neutral_element_NTP::applicative_pure_t<do_nothing,neutral_element_NTP>>);
...
using Applicative_TP4 = Applicative_TP1::template applicative_pure_t<std::variant,Applicative_TP2,Applicative_TP3>;
...
static_assert(std::is_same_v<param_pack::type_pack_t<std::variant<>>, neutral_element_TP::applicative_pure_t<std::variant,neutral_element_TP>>);
