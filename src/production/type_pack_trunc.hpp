...
private:
  ...
  requires type_pack_t<Other_Packs...>::template functor_map_t<same_size>::template fold_t<helpers::And,std::true_type>::value
  struct applicative_pure{
    using type = pure_logic<Class_Templ, 0, type_pack_t<type_pack_t<Ts...>,Other_Packs...>, type_pack_t<>>::type;
  };
